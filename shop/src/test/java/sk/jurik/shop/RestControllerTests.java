...
public class RestControllerTests {
    ...
    public void createMerchant() throws Exception {
        if (merchant == null) {
            merchant = new Merchant("Ferko", "email", "address");
    ...
    public void product() throws Exception {
        Product product = new Product(merchant.getId(),"Pohar","Skleneny",20,100);
        ...
        //Patch product
        double updatePrice = product.getPrice() + 1000;
        int updatedAvailable = product.getAvailable() + 1000;
        UpdateProductRequest request = new UpdateProductRequest(product.getName(),product.getDescription(), updatePrice,updatedAvailable);
    ...
    public void customer() throws Exception {
        Customer customer = new Customer("Ferko", "Mrvka", "email", "address", 25, "999");
